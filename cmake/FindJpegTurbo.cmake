...
if(LAF_BACKEND STREQUAL "skia")
  ...
  set(LIBJPEG_TURBO_CMAKE_CACHE_ARGS)
  if(ANDROID)
    file(TO_CMAKE_PATH "${CMAKE_TOOLCHAIN_FILE}" LIBJPEG_TURBO_TOOLCHAIN_FILE)
    list(APPEND LIBJPEG_TURBO_CMAKE_CACHE_ARGS
      -DCMAKE_TOOLCHAIN_FILE:FILEPATH=${LIBJPEG_TURBO_TOOLCHAIN_FILE}
  ...
  ExternalProject_Add(libjpeg-turbo-project
    ...
    ${LIBJPEG_TURBO_CMAKE_CACHE_ARGS})
